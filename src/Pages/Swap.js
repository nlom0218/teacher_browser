...
const Swap = () => {
  ...
  return (
    <BasicContainer menuItem={true}>
          ...
          (selectedStudent.length === 0 ? (
            ...
            <React.Fragment>
              <OptionContents>
                ...
                <SettingBtn>
                  <DetailSetting onClick={onClickDetailSetting}>
                    <FcSettings />
                  </DetailSetting>
                  <FontSizeBtn setFontSizeAll={setFontSizeAll} fontSizeAll={fontSizeAll} />
                </SettingBtn>
              </OptionContents>
              <StudentOrder
      ...
      {isPopup === "print" && <PrintSwapContents printRef={componentRef} title={title} selectedStudent={selectedStudent} pickNum={pickNum} seatType={seatType} />}
      {isPopup === "needLogin" && <NeedLoginPopupContainer />}
      {isPopup === "detailSetting" && (
        <SwapDetailSetting setErrMsg={setErrMsg} pickNum={pickNum} setPickNum={setPickNum} seatType={seatType} setSeatType={setSeatType} mateGender={mateGender} setMateGender={setMateGender} />
      )}
      {isShuffle === "pickNum" && <StudentNumber pickNum={pickNum} setPickNum={setPickNum} onClickShuffleBtn={onClickShuffleBtn} setErrMsg={setErrMsg} />}
      {isShuffle === "ing" && <Shuffling onClickShuffleBtn={onClickShuffleBtn} sort={sort} setSort={setSort} hasNum={hasNum} setErrMsg={setErrMsg} />}
