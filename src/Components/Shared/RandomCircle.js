...
const RandomCircle = () => {
  return (<Container>
    <First><IcRandomCircleMint /></First>
    <Second><IcRandomCirclePink /></Second>
    <Third><IcRandomCircleSky /></Third>
    <Fourth><IcRandomCircleOrange /></Fourth>
    <Fifth><IcRandomCirclePurple /></Fifth>
    <Sixth><IcRandomCircleYellow /></Sixth>
  </Container>);
}
